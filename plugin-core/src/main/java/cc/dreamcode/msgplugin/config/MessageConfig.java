package cc.dreamcode.msgplugin.config;
...
@Headers({
        @Header("## Dream-MsgPlugin (Message-Config) ##"),
...
public class MessageConfig extends OkaeriConfig {
    ...
    public BukkitNotice ambigousPlayer = BukkitNotice.chat("&cNie możesz wysłać do siebie wiadomości!");
